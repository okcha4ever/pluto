      ...
      <div className="flex justify-center items-center min-h-screen bg-[#f0f2f5]">
        <div className="text-center px-4 py-10 sm:m-10 shadow-lg bg-[#3b49df11] rounded-lg max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-10 my-4 sm:my-10">
            <button onClick={() => console.log("clicked investor")} className="transition-transform transform hover:scale-105 max-w-sm w-full sm:w-auto p-6 bg-white border-2 border-gray-300 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-600 hover:bg-gray-800">
              <a href="#" className="focus:outline-none focus:ring focus:ring-opacity-50">
            ...
            <button onClick={() => console.log("clicked startup")} className="transition-transform transform hover:scale-105 max-w-sm w-full sm:w-auto p-6 bg-white border-2 border-gray-300 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-600 hover:bg-gray-800">
              <a href="#" className="focus:outline-none focus:ring focus:ring-opacity-50">
